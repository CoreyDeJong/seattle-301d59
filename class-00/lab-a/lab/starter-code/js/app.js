...
function displayPics(){
  ...
  // using let within the displayPics function does not define rando outside of the function, therefore rando cannot be console logged given rando is not defined.
  console.log(viewed);
